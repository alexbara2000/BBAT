...
function showTabContextMenu(event, source) {
  return async ({
    ...
    const isBlackBoxed = (0, _selectors.isSourceBlackBoxed)(state, source);
    ...
    const tabsSources = (0, _selectors.getSourcesForTabs)(state);
    ...
    const items = [{
      ...
      item: { ...tabMenuItems.copySource,
        ...
        disabled: (selectedLocation === null || selectedLocation === void 0 ? void 0 : selectedLocation.source.id) !== source.id,
        click: () => {
