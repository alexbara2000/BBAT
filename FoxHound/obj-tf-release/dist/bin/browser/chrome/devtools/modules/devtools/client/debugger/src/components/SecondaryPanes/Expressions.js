...
class Expressions extends _react.Component {
  ...
  static get propTypes() {
    return {
      ...
      isOriginalVariableMappingDisabled: _propTypes.default.bool,
      isLoadingOriginalVariables: _propTypes.default.bool
    };
  }
...
const mapStateToProps = state => {
  ...
  const mapScopesEnabled = (0, _selectors.isMapScopesEnabled)(state);
  const expressions = (0, _selectors.getExpressions)(state);
  const selectedSourceIsNonPrettyPrintedOriginal = (selectedSource === null || selectedSource === void 0 ? void 0 : selectedSource.isOriginal) && !(selectedSource === null || selectedSource === void 0 ? void 0 : selectedSource.isPrettyPrinted);
  let isOriginalVariableMappingDisabled, isLoadingOriginalVariables;

  if (selectedSourceIsNonPrettyPrintedOriginal) {
    var _getOriginalFrameScop;

    isOriginalVariableMappingDisabled = isPaused && !mapScopesEnabled;
    isLoadingOriginalVariables = isPaused && mapScopesEnabled && !expressions.length && !((_getOriginalFrameScop = (0, _selectors.getOriginalFrameScope)(state, selectedFrame)) === null || _getOriginalFrameScop === void 0 ? void 0 : _getOriginalFrameScop.scope);
  }
