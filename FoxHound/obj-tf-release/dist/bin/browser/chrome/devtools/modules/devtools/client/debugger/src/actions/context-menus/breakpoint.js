...
function showBreakpointContextMenu(event, breakpoint, source) {
  return async ({
    ...
    const checkSourceOnIgnoreList = _source => (0, _selectors.isSourceMapIgnoreListEnabled)(state) && (0, _selectors.isSourceOnSourceMapIgnoreList)(state, _source);
    ...
    const deleteAllItem = {
      ...
      disabled: false,
      click: () => dispatch((0, _index.removeAllBreakpoints)())
    };
    const deleteOthersItem = {
      ...
      disabled: false,
      click: () => dispatch((0, _index.removeBreakpoints)(otherBreakpoints))
    };
    const enableSelfItem = {
      ...
      click: () => {
        dispatch((0, _index.toggleDisabledBreakpoint)(breakpoint));
      }
    };
    const enableAllItem = {
      ...
      disabled: (0, _source2.isLineBlackboxed)(blackboxedRangesForSource, breakpoint.location.line, checkSourceOnIgnoreList(breakpoint.location.source)),
      click: () => dispatch((0, _index.toggleAllBreakpoints)(false))
    };
    const enableOthersItem = {
      ...
      disabled: (0, _source2.isLineBlackboxed)(blackboxedRangesForSource, breakpoint.location.line, checkSourceOnIgnoreList(breakpoint.location.source)),
      click: () => dispatch((0, _index.toggleBreakpoints)(false, otherDisabledBreakpoints))
    };
    ...
    const disableAllItem = {
      ...
      disabled: false,
      click: () => dispatch((0, _index.toggleAllBreakpoints)(true))
    };
    const disableOthersItem = {
      id: "node-menu-disable-others",
      label: disableOthersLabel,
      accesskey: disableOthersKey,
      click: () => dispatch((0, _index.toggleBreakpoints)(true, otherEnabledBreakpoints))
    };
