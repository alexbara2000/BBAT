...
async function loadOriginalSource(source, {
  ...
  if ((0, _source.isPretty)(source)) {
    ...
    return (0, _prettyPrint.prettyPrintSourceTextContent)(sourceMapLoader, prettyPrintWorker, generatedSource, content, (0, _selectors.getSourceActorsForSource)(getState(), generatedSource.id));
  }
...
async function onSourceTextContentAvailable(source, sourceActor, {
  ...
  const breakpoints = (0, _selectors.getBreakpointsForSource)(getState(), source);

  for (const breakpoint of breakpoints) {
    await dispatch((0, _breakpoints.addBreakpoint)(breakpoint.location, breakpoint.options, breakpoint.disabled));
  }
}
/**
