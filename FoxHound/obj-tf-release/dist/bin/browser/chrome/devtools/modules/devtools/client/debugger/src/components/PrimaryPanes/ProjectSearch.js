...
class ProjectSearch extends _react.Component {
  constructor(props) {
    ...
    _defineProperty(this, "selectMatchItem", async matchItem => {
      ...
      this.props.doSearchForHighlight(this.state.query, (0, _editor.getEditor)(), matchItem.location.line, matchItem.location.column);
    });
    ...
    _defineProperty(this, "renderFile", (file, focused, expanded) => {
      ...
      return (0, _reactDomFactories.div)({
        ...
        className: "file-path"
      }, file.location.source.url ? (0, _utils.getRelativePath)(file.location.source.url) : (0, _source.getFormattedSourceId)(file.location.source.id)), (0, _reactDomFactories.span)({
  ...
  static get propTypes() {
    return {
      ...
      selectSpecificLocationOrSameUrl: _propTypes.default.func.isRequired,
...
const mapStateToProps = state => ({
  ...
  navigateCounter: (0, _selectors.getNavigateCounter)(state)
});

var _default = (0, _connect.connect)(mapStateToProps, {
  searchSources: _actions.default.searchSources,
  selectSpecificLocationOrSameUrl: _actions.default.selectSpecificLocationOrSameUrl,
