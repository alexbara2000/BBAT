...
function updateBreakpointsForNewPrettyPrintedSource(source) {
  return async thunkArgs => {
    ...
    const breakpoints = (0, _selectors.getBreakpointsForSource)(getState(), source); // Remap the breakpoints with the original location information from
...
function removeBreakpointsAtLine(source, line) {
  return ({
    ...
    const breakpointsAtLine = (0, _selectors.getBreakpointsForSource)(getState(), source, line);
