...
class Scopes extends _react.PureComponent {
  ...
  renderScopesList() {
    ...
    if (selectedSource.isOriginal && !selectedSource.isPrettyPrinted && !((_selectedFrame$genera = selectedFrame.generatedLocation) === null || _selectedFrame$genera === void 0 ? void 0 : _selectedFrame$genera.source.isWasm)) {
      if (!mapScopesEnabled) {
        return (0, _reactDomFactories.div)({
          className: "pane scopes-list"
        }, (0, _reactDomFactories.div)({
...
const mapStateToProps = state => {
  var _selectedFrame$genera2;

  // This component doesn't need any prop when we are not paused
  const selectedFrame = (0, _selectors.getSelectedFrame)(state, (0, _selectors.getCurrentThread)(state));
  const why = (0, _selectors.getPauseReason)(state, selectedFrame.thread);
  const expandedScopes = (0, _selectors.getLastExpandedScopes)(state, selectedFrame.thread);
  ...
  if ((selectedSource === null || selectedSource === void 0 ? void 0 : selectedSource.isOriginal) && !(selectedSource === null || selectedSource === void 0 ? void 0 : selectedSource.isPrettyPrinted) && !((_selectedFrame$genera2 = selectedFrame.generatedLocation) === null || _selectedFrame$genera2 === void 0 ? void 0 : _selectedFrame$genera2.source.isWasm)) {
    const {
      scope,
      pending: originalPending
    } = (0, _selectors.getOriginalFrameScope)(state, selectedFrame) || {
      scope: null,
      pending: false
    };
    ...
    } = (0, _selectors.getGeneratedFrameScope)(state, selectedFrame) || {
      scope: null,
      pending: false
    };
