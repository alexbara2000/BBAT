...
function update(state = initialUIState(), action) {
  switch (action.type) {
    ...
    case "REMOVE_THREAD":
      {
        var _state$highlightedLin;

        // Reset the highlighted range if the related source has been removed
        const sourceId = (_state$highlightedLin = state.highlightedLineRange) === null || _state$highlightedLin === void 0 ? void 0 : _state$highlightedLin.sourceId;
