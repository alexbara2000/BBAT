...
function matchesSource(tab, source) {
  ...
  return ((_tab$source = tab.source) === null || _tab$source === void 0 ? void 0 : _tab$source.id) === source.id || matchesUrl(tab, source);
}
...
function resetTabsForThread(state, threadActorID) {
  ...
  const tabs = state.tabs.map(tab => {
    var _tab$sourceActor;

    if (((_tab$sourceActor = tab.sourceActor) === null || _tab$sourceActor === void 0 ? void 0 : _tab$sourceActor.thread) != threadActorID) {
      return tab;
    }
...
function moveTabInListBySourceId(state, {
  ...
  const currentIndex = state.tabs.findIndex(tab => {
    var _tab$source2;

    return ((_tab$source2 = tab.source) === null || _tab$source2 === void 0 ? void 0 : _tab$source2.id) == sourceId;
  });
  return moveTab(state, currentIndex, newIndex);
}
