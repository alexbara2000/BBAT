...
const getVisibleBreakpoints = (0, _reselect.createSelector)(_sources.getSelectedSource, _breakpoints.getBreakpointsList, (selectedSource, breakpoints) => {
  ...
  return breakpoints.filter(bp => {
    ...
    return selectedSource && ((_getSelectedLocation = (0, _selectedLocation.getSelectedLocation)(bp, selectedSource)) === null || _getSelectedLocation === void 0 ? void 0 : _getSelectedLocation.source.id) === selectedSource.id;
  });
});
/*
