...
function showBreakpointHeadingContextMenu(event, source) {
  return async ({
    ...
    const breakpointsForSource = (0, _selectors.getBreakpointsForSource)(state, source);
    ...
    const disableInSourceItem = {
      ...
      disabled: false,
      click: () => dispatch((0, _index.disableBreakpointsInSource)(source))
    };
    const enableInSourceItem = {
      ...
      disabled: false,
      click: () => dispatch((0, _index.enableBreakpointsInSource)(source))
    };
    const removeInSourceItem = {
      ...
      disabled: false,
      click: () => dispatch((0, _index.removeBreakpointsInSource)(source))
    };
