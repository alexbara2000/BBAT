...
function showEditorEditBreakpointContextMenu(event, breakpoint) {
  return async ({
    ...
    const isSelectedSourceOnIgnoreList = selectedSource && (0, _selectors.isSourceMapIgnoreListEnabled)(state) && (0, _selectors.isSourceOnSourceMapIgnoreList)(state, selectedSource);
...
const toggleDisabledBreakpointItem = (breakpoint, blackboxedRangesForSelectedSource, isSelectedSourceOnIgnoreList, dispatch) => {
  return {
    ...
    click: () => dispatch((0, _index.toggleDisabledBreakpoint)(breakpoint)),
    ...(breakpoint.disabled ? {
...
const removeBreakpointsOnLineItem = (location, dispatch) => ({
  ...
  disabled: false,
  click: () => dispatch((0, _index.removeBreakpointsAtLine)(location.source, location.line))
});
...
const enableBreakpointsOnLineItem = (location, blackboxedRangesForSelectedSource, isSelectedSourceOnIgnoreList, dispatch) => ({
  ...
  click: () => dispatch((0, _index.enableBreakpointsAtLine)(location.source, location.line))
});
...
const disableBreakpointsOnLineItem = (location, dispatch) => ({
  ...
  disabled: false,
  click: () => dispatch((0, _index.disableBreakpointsAtLine)(location.source, location.line))
});