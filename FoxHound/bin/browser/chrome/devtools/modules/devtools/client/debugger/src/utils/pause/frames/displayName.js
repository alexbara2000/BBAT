...
function formatDisplayName(frameOrFunc, {
  ...
  if (library && shouldMapDisplayName) {
    var _displayNameLibraryMa;

    displayedName = (_displayNameLibraryMa = displayNameLibraryMap[library]) === null || _displayNameLibraryMa === void 0 ? void 0 : _displayNameLibraryMa[displayName];
