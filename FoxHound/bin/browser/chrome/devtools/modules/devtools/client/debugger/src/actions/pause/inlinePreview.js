...
function generateInlinePreview(selectedFrame) {
  return async function ({
    ...
    if ((0, _selectors.getInlinePreviews)(getState(), selectedFrame.thread, selectedFrame.id)) {
      return null;
    }

    const originalFrameScopes = (0, _selectors.getOriginalFrameScope)(getState(), selectedFrame);
    const generatedFrameScopes = (0, _selectors.getGeneratedFrameScope)(getState(), selectedFrame);
